...
contract SuiviMed is AccessControl {
     ...
     */
    constructor(address _addressPromoter, address _addressAuthority) {
        /**
    ...
    /*     function storeCID(string memory cid) public returns (bool) {
        uint256 l1 = cids.length;
        cids.push(cid);
        uint256 l2 = cids.length;
    ...
    function getCID(uint256 id) public returns (string memory) {
        return cids[id];
    } */
}
