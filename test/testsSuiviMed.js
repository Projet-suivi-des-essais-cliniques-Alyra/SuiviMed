...
contract("SuiviMed", function (accounts) {
    ...
    it('verifies createProtocol', async function () {
        ...
        await expectRevert(this.SuiviMedInstance.createProtocol(0,"descriptionCID","treatmentListCID",{from:promoter2}),
        "Not among promoters of this protocol!");
    })
    ...
    it('verifies alert on protocol prevents data of patients to be collected or patients to be added ', async function () {
        ...
        await this.SuiviMedInstance.createProtocol(0,"descriptionCID","treatmentListCID",{from:promoter1});
        //authority1 validates protocol[0]
        await this.SuiviMedInstance.validateProtocol(0,0,{from:authority1});
        //promoter1 creates project[0] and add investigator1
        await this.SuiviMedInstance.createProject(0,0,investigator1,{from:promoter1});
        //investigator1 adds patients to projects[0]
        await this.SuiviMedInstance.addPatient(patient1,0,0,"Data1aCID","Name1CID",{from:investigator1});
        await this.SuiviMedInstance.addPatient(patient2,0,0,"Data2aCID","Name2CID",{from:investigator1});
        ...
        await expectRevert(this.SuiviMedInstance.addPatient(patient3,0,0,"Data3aCID","Name3CID",{from:investigator1}),"This protocol has an alert!");
        // //verifies that the investigator1 cannot add collect data of patients while alert is on for protocol[0]
        await expectRevert(this.SuiviMedInstance.collectData(0,"Data3bCID",{from:investigator1}),
    ...
    it('verifies data of patients that revoked their consent, cannot be collected anymore', async function () {
        await this.SuiviMedInstance.addPromoter(promoter1,{from:promoterAdmin});
        await this.SuiviMedInstance.addAuthority(authority1,{from:authorityAdmin});
        //promoter1 creates protocol[0]
        await this.SuiviMedInstance.createProtocol(0,"descriptionCID","treatmentListCID",{from:promoter1});
